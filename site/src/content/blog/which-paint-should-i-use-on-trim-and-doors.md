...
Oil-Based Paint: This was the tried and true paint for woodwork in past generations. The biggest benefit of oil-based paint is the smooth, strong finish it provides. Oil-based paints have fallen out of favor lately for several key reasons. The biggest concern is the strong odors and [VOCs](https://www.epa.gov/indoor-air-quality-iaq/what-are-volatile-organic-compounds-vocs) given off as the paint dries. These chemicals are not as safe as water-based options that are now available.
