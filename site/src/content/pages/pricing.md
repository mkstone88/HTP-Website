...
<div class="price-cards">
  ...
  <div class="compare-card">
    ...
    <div class="price-tag">$5–$10 / sq ft</div>
    <p>Depends on whether woodwork is included along with walls and ceilings.</p>
    <a href="/pricing/interior-pricing/">See interior pricing →</a>
  </div>
  <div class="compare-card">
    <h4>Fence Staining</h4>
    <div class="price-tag">$2,000–$4,000</div>
    <p>For a full backyard. Yard size is the biggest factor.</p>
    <a href="/cost-to-stain-a-fence-okc/">See fence pricing →</a>
  </div>
</div>

<a class="prose-cta" href="/contact-us/">Get a Free Estimate →</a>

## What Influences Paint Job Costs
